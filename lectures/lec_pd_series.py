...
# if pandas is imported as pd the series constructor can be assessed with pd.Series().
...
# listing the lists:
prices[dates.index('2020-01-06'):dates.index('2020-01-10')+1]  # [7.0, 7.1, 6.86, 6.95, 7.0]
...
# instance)
print(type(ser.array))  # <class 'pandas.core.arrays.numpy_.PandasArray'>
...
#    (or 6.86)
print(ser[-4])  # not the 4th element

# 2. This will return the fourth element from the end of the **list** `prices`
#    (or 7.00)
print(prices[-4])  # showed the last 4th element

''' week 5 2.2 Pandas DataFrames
a DataFrame in pandas is analogous to a spreadsheet  in Excel pandas 中的 DataFrame 类似于 Excel 中的电子表格
using the DataFrame constructor:pd.DataFrame(arguments).
DataFrame accepts many different kinds of input arguments - Can create a DataFrame in many ways'''
# then open led_pd_dataframes.py
